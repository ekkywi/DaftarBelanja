<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-4 ml-4" href="{{ route("dashboard") }}"><img alt="logo" class="mr-2" src="{{ asset("images/logo.svg") }}" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route("dashboard") }}"><img alt="logo" src="{{ asset("images/logo-mini.svg") }}" /></a>
    </div>
